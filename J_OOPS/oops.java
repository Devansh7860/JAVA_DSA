...
public class oops {
    ...
    // in java there is no pass by reference for primitive data types. only pass by value
    // but in case of objects it is pass by reference.
    // so when we pass an object to a function we are passing the address of that object.
